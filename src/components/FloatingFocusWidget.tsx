      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <Button
            ...
            className={`${isActive ? 'bg-gradient-to-r from-red-500 to-pink-500' : 'bg-gradient-to-r from-green-500 to-emerald-500'} text-white font-medium`}
          >
            {isActive ? (
              <>
        ...
        <div className="space-y-3">
          ...
          {progressPercentage >= 100 && (
            <div className="p-3 bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 rounded-xl border border-green-200 dark:border-green-800 animate-gentle-pulse">
              <div className="flex items-center space-x-2">
