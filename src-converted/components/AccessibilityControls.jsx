...
export const AccessibilityControls = ({ isDyslexicFont, setIsDyslexicFont, isHighContrast, setIsHighContrast, isFocusMode, setIsFocusMode, isReducedMotion, setIsReducedMotion, }) => {
